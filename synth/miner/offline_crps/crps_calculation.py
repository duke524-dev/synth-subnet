"""
VERBATIM COPY FROM VALIDATOR CODE - DO NOT MODIFY

Source: synth/validator/crps_calculation.py
Copied for offline CRPS replay to ensure exact validator scoring logic.

This file must match the validator's CRPS calculation exactly.
Any modifications must be synchronized with the validator codebase.
"""
